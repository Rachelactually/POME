...
def main():
 ...
 with tab1:
    ...
    # Create subheaders for main performance indicator  
        ...
        # GPR
        new_title = '<p style="font-family:monospace; color:orange; font-size: 20px;">Gaussian Process Regressor (GPR)</p>'
        st.markdown(new_title, unsafe_allow_html=True)
        ...
        # XGBoost
        new_title = '<p style="font-family:monospace; color:orange; font-size: 20px;">Extreme Gradient Boosting (XGBoost)</p>'
        st.markdown(new_title, unsafe_allow_html=True)
        ...
        # RF
        new_title = '<p style="font-family:monospace; color:orange; font-size: 20px;">Random Forest (RF)</p>'
        st.markdown(new_title, unsafe_allow_html=True)  
